...
namespace RedisClientTest
{
    public class Tests : TestBase
    {
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("key", value, CompressionType.None);
        ...
        public async Task Multiple_Values_With_Space()
        {
            ...
            await (await TomLonghurstRedisClient).StringSetAsync(data, CompressionType.None);
        ...
        public async Task LargeValue(string key, string filename)
        {
            ...
            await (await TomLonghurstRedisClient).StringSetAsync(key, largeValueJson, CompressionType.None);
        ...
        public async Task Test1Async()
        {
            ...
            await (await TomLonghurstRedisClient).StringSetAsync("TestyMcTestFace", "123", 120, CompressionType.None);
            await (await TomLonghurstRedisClient).StringSetAsync("TestyMcTestFace2", "1234", 120, CompressionType.None);
            await (await TomLonghurstRedisClient).StringSetAsync("TestyMcTestFace3", "12345", 120, CompressionType.None);
            ...
            await (await TomLonghurstRedisClient).StringSetAsync("KeyExists", "123", CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("Exists", "123", 30, CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("SingleKey", "123", CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("SingleKeyWithTtl", "123", 30, CompressionType.None);
        ...
        public async Task SetGetMultipleKey()
        {
            ...
            await (await TomLonghurstRedisClient).StringSetAsync(keyValues, CompressionType.None);
        ...
        public async Task Pipelining_Multiple_Sets()
        {
            ...
            var results = keys.Select(key => tomLonghurstRedisClient.StringSetAsync(key, "123", 30, CompressionType.None));
        ...
        public async Task SetGetMultipleKeyWithTtl()
        {
            ...
            await (await TomLonghurstRedisClient).StringSetAsync(keyValues, 120, CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("KeyExistsCheck", "123", 30, CompressionType.None);
        ...
        {
            var client = await _redisManager.GetRedisClientAsync();
            await client.StringSetAsync("DisconnectTest", "123", 120, CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("ExpireKey", "123", CompressionType.None);
        ...
        {
            await (await TomLonghurstRedisClient).StringSetAsync("ExpireKeyDateTime", "123", CompressionType.None);
