...
namespace RedisClientTest
{
    public class Tests
    {
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("key", value, AwaitOptions.AwaitCompletion);
        ...
        public async Task Multiple_Values_With_Space()
        {
            ...
            await TomLonghurstRedisClient.StringSetAsync(data, AwaitOptions.AwaitCompletion);
       ...
       [TestCase(TestClient.StackExchange)]
        ...
        public async Task Test1Async()
        {
            ...
            await TomLonghurstRedisClient.StringSetAsync("TestyMcTestFace", "123", 120, AwaitOptions.FireAndForget);
            await TomLonghurstRedisClient.StringSetAsync("TestyMcTestFace2", "1234", 120, AwaitOptions.FireAndForget);
            await TomLonghurstRedisClient.StringSetAsync("TestyMcTestFace3", "12345", 120, AwaitOptions.FireAndForget);
            ...
            await TomLonghurstRedisClient.StringSetAsync("KeyExists", "123", AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("Exists", "123", 30, AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("SingleKey", "123", AwaitOptions.AwaitCompletion);
            var redisValue = await TomLonghurstRedisClient.StringGetAsync("SingleKey");
            Assert.That(redisValue.Value, Is.EqualTo("123"));
            
            await TomLonghurstRedisClient.DeleteKeyAsync("SingleKey", AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("SingleKeyWithTtl", "123", 30, AwaitOptions.AwaitCompletion);
        ...
        public async Task SetGetMultipleKey()
        {
            ...
            await TomLonghurstRedisClient.StringSetAsync(keyValues, AwaitOptions.AwaitCompletion);
        ...
        public async Task Pipelining_Multiple_Sets()
        {
            ...
            var results = keys.Select(async key =>
                await TomLonghurstRedisClient.StringSetAsync(key, "123", 30, AwaitOptions.FireAndForget));
        ...
        public async Task SetGetMultipleKeyWithTtl(AwaitOptions awaitOptions)
        {
            ...
            await TomLonghurstRedisClient.StringSetAsync(keyValues, 120, awaitOptions);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("KeyExistsCheck", "123", 30, AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.DeleteKeyAsync(key, AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("ExpireKey", "123", AwaitOptions.AwaitCompletion);
        ...
        {
            await TomLonghurstRedisClient.StringSetAsync("ExpireKeyDateTime", "123", AwaitOptions.AwaitCompletion);
