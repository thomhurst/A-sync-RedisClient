...
namespace TomLonghurst.AsyncRedisClient.Models.Backlog
{
    public struct BacklogItem<T> : IBacklogItem<T>
    {
        ...
        public IRedisEncodable RedisCommand { get; }
        ...
        public BacklogItem(IRedisEncodable redisCommand, CancellationToken cancellationToken, TaskCompletionSource<T> taskCompletionSource, AbstractResultProcessor<T> abstractResultProcessor, Client.RedisClient redisClient, PipeReader pipe)
        {
